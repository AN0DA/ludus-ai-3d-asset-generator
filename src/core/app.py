...
from ..generators.llm_generator import LLMGenerator, LLMConfig
from ..generators.asset_generator import (
    Asset3DGenerator, GenerationRequest, ServiceProvider, 
    ServiceConfig, GenerationResult
)
from ..storage.cloud_storage import StorageConfig, StorageProvider
...
class AssetGenerationApp:
    ...
    def __init__(self, config_path: Optional[Path] = None):
        ...
        self.cloud_storage: Optional[S3Storage] = None
