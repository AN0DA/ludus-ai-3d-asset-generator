...
class EnhancedAssetDescription(BaseModel):
    ...
    estimated_polygon_count: int | None = None
...
class LLMGenerator(BaseGenerator):
    ...
    def __init__(self, config: LLMConfig) -> None:
        super().__init__(config, name="LLMGenerator")
        ...
        self.few_shot_examples = [
            {
                ...
                "output": {
                    ...
                    "color_palette": ["steelgray", "brown leather", "brass"],
        ...
        **kwargs: Any,
        ...
        try:
            ...
            result.data = {
                ...
                "asset_type": kwargs.get("asset_type"),
                "style_preferences": [s.value for s in kwargs.get("style_preferences", [])]
                if kwargs.get("style_preferences")
                else [],
                "quality_level": kwargs.get("quality_level"),
