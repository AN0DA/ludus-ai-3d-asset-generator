...
class Asset3DGeneratorUI:
            ...
            with gr.Column(scale=2):
                with gr.Group(elem_classes=["section-card"]):
                    ...
                    generate_btn = gr.Button(
                        "🚀 Generate Asset", variant="primary", elem_classes=["btn-primary"], size="lg"
                    )
    ...
    def _create_results_tab(self):
        ...
        refresh_assets_btn.click(fn=self._refresh_asset_list, outputs=[asset_list])
    ...
    def _create_history_tab(self):
        ...
        refresh_history_btn.click(fn=self._refresh_history, outputs=[history_gallery])

        clear_history_btn.click(fn=self._clear_history, outputs=[history_gallery])
